        ...
        <div className={`container  ${styles.footer__2}`}>
          <div className="row d-flex justify-content-center">
            <div className="col-md-10 ">
              ...
              <p className={`text-white ${styles.footpara__2}`}>
                Enter your email here*
              </p>
              <div className="input-group mb-3 pb-5">
                <input
                  type="text"
                  className={`form-control ${styles.footsearch__1}`}
                  aria-label="Recipient's username"
                  aria-describedby="basic-addon2"
                />
                <span
                  className={`input-group-text  text-white ${styles.footsearch__2}`}
                  id="basic-addon2"
                >
                  Join
                </span>
          ...
          <div className="row pt-5">
            <div className="col-md-7 text-center">
              <p className="text-white ">
                ...
                <span className="text-decoration-underline">Wix.com</span>
              </p>
            </div>
