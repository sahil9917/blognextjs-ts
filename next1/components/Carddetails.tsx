      ...
      <div className="container">
        ...
        <div className="row d-flex flex-row justify-content-center">
          <div className={`col-md-8 card ${styles.cardid__1}`}>
            ...
            <p className={` pt-2 ${styles.paradis__1}`}>
            ...
            <div>
              <h3 className={`py-3 ${styles.headdis__1}`}>
            ...
            <div className="row py-4">
              <div
                className={`col-md-2 d-flex flex-column ${styles.detailspara__2} `}
              >
                <small className="text-start">0 Views</small>
              </div>
              <div
                className={`col-md-3 d-flex flex-column ${styles.detailspara__2} `}
              >
        ...
        <div className="row d-flex justify-content-center py-5">
          <div className="col-md-10 ">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <Recentpost
                  title="The art of writing change your perspective"
                  srcimg={pic2}
                />
              </div>
              <div className="col-md-4">
        ...
        <div className="row d-flex justify-content-center py-5">
          <div className="col-md-8 d-flex flex-column justify-content-center">
            ...
            <hr />
            <p className={`text-center py-1 ${styles.commentpara__1} `}>
              Couldn’t Load Comments <br />
              It looks like there was a technical problem. Try reconnecting or
              refreshing the page.
            </p>
