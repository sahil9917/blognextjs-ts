    ...
    <>
      <div className="card">
        ...
        <div className="card-body">
          <h5 className={`card-title ${styles.cardtitle2__1}`}>
            {props.title}
          </h5>
          <div className="row py-2">
            <div
              className={`col-md-3 d-flex flex-column ${styles.carddetails2__1} `}
            >
            ...
            <div
              className={`col-md-3 d-flex flex-column ${styles.carddetails2__2} `}
            >
              <small className="text-start">
